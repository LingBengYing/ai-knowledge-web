...
先读 [README](README.md)、[AI_CONTEXT](docs/AI_CONTEXT.md)、[ARCHITECTURE](docs/ARCHITECTURE.md) 和 [API_CONNECTION](docs/API_CONNECTION.md)，再按顺序读当前 [0001-frontend-publication](docs/changes/0001-frontend-publication/) 的 intent、spec、plan、REVIEW。工件和实际路由是 source of truth。

- 当前仅管理前端与本地开发代理，不是完整 Java RAG 或生产部署。不可将禁用按钮、类型筛选或合成资料写成上传/多模态/问答已完成。
